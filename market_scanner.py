...
.stat{flex:0 0 145px;padding:11px 12px;min-height:58px}.label{font-size:10px;color:#6b7280;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap}.num{font-size:17px;font-weight:750;margin-top:3px;white-space:nowrap}
...
.technical-panel{flex:1 0 720px;min-width:720px;padding:0;margin:0;overflow:hidden}.technical-compact-summary{display:flex;align-items:center;gap:8px;min-height:58px;padding:7px 10px;cursor:pointer;list-style:none}.technical-compact-summary::-webkit-details-marker{display:none}.technical-compact-summary:after{content:'▾';color:#0f766e;font-size:14px;transition:transform .18s ease}.technical-panel[open] .technical-compact-summary:after{transform:rotate(180deg)}.technical-compact-title{font-size:12px;font-weight:850;white-space:nowrap}.technical-badge{border-radius:999px;padding:5px 7px;background:#ecfeff;font-size:11px;font-weight:850;white-space:nowrap}.technical-summary{display:flex;align-items:center;gap:5px;min-width:0;flex:1;margin:0}.technical-card{display:flex;align-items:center;gap:5px;min-width:0;flex:1;border:1px solid #ccfbf1;border-radius:9px;background:#f0fdfa;padding:5px 7px}.technical-card span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#64748b;font-size:10px;flex:1}.technical-card b{white-space:nowrap;font-size:11px}.technical-card small{white-space:nowrap;color:#64748b;font-size:9px}.technical-open-label{max-width:140px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#475569;font-size:10px;font-weight:800}.technical-details-content{padding:10px 12px 12px;border-top:1px solid #e5e7eb}.technical-shadow-note{margin:0 0 8px;color:#6b7280;font-size:11px}.direction-bullish{color:#16a34a!important}.direction-bearish{color:#dc2626!important}.direction-neutral{color:#64748b!important}.technical-conflict{border-left:4px solid #f59e0b;background:#fffbeb;padding:10px 12px;font-weight:750}.technical-table-wrap{overflow:auto}.technical-table{width:100%;border-collapse:collapse;font-size:12px}.technical-table th,.technical-table td{padding:8px;border-bottom:1px solid #e5e7eb;text-align:left;white-space:nowrap}
